function [Acc,rand_index,match]=accuracy_calculator(T,idx)
% File from Mathworks: 
% Praisan Padungweang. MathWorks file exchange.
% https://www.mathworks.com/matlabcentral/fileexchange/32197-clustering-results-measurement
